...
void ScopeProDebug(void)//����ʱ���������� 
{
	...
	i+=2;*(u16*)(&g_UserDefined_TxBuf[g_TxBuf_Pos+i]) = g_CmdMap[CMD_SPD_ACT_PU];//estimated_SPD_filterd;//g_CmdMap[CMD_SPD_ADD_PU];//g_CmdMap[CMD_SPD_ADD_PU]/100;//g_CmdMap[CMD_SPD_SOFT_SET_PU];// CMD_CUR_FWD_PU  //CMD_SPD_ADD_PU
	i+=2;*(u16*)(&g_UserDefined_TxBuf[g_TxBuf_Pos+i]) = g_IA_Raw*PU_REFERENCE/(*g_pCur_ref_base_mA);//g_CmdMap[CMD_CUR_SET_PU];//g_CmdMap[CMD_CUR_SET_PU];//g_CmdMap[CMD_CUR_SET_PU];
	i+=2;*(u16*)(&g_UserDefined_TxBuf[g_TxBuf_Pos+i]) = g_IB_Raw*PU_REFERENCE/(*g_pCur_ref_base_mA);//g_Iq*PU_REFERENCE/(*g_pCur_ref_base_mA);
	i+=2;*(u16*)(&g_UserDefined_TxBuf[g_TxBuf_Pos+i]) = 0*PU_REFERENCE/(*g_pCur_ref_base_mA);//g_IB_Raw*PU_REFERENCE/(*g_pCur_ref_base_mA);; // CMD_CUR_FWD_PU //CMD_CUR_D_ACT_PU
	i+=2;*(u16*)(&g_UserDefined_TxBuf[g_TxBuf_Pos+i]) = g_ElectricAngle ;//g_ElectricAngle_15bit_Raw;//g_ElectricAngle_15bit_Raw;//g_ElectricAngle_15bit_Raw;  //g_ElectricAngle_15bit_Raw;//g_ElectricAngle_15bit_Raw;
