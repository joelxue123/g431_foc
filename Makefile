##########################################################################################################################
# File automatically-generated by tool: [projectgenerator] version: [4.3.0-B58] date: [Wed Aug 07 17:31:07 CST 2024] 
##########################################################################################################################
...
Src/icmu.c \
Src/led.c \
Src/limit_pos_detection.c \
Src/nvic.c \
Src/parameter_identification.c \
...
TEST_INCLUDES = -I. -I./Tests/googletest -I./Tests/googletest/include -I./Tests/googlemock -I./Tests/googlemock/include
...
Tests/test_runner.exe: $(patsubst %.cpp,%.o,$(wildcard Tests/*.cpp))
	g++ $^ -o $@ $(TEST_LIB)

# Rule to run tests
run_tests: Tests/test_runner.exe
	echo $(TEST_INCLUDES)
	$<
